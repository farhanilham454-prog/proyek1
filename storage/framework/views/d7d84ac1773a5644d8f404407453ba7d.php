...
<div id="mainContent" class="main-content container mt-5">
    ...
    <div class="text-center mb-4">
        <form method="GET" action="/diagram">
            <select name="periode" class="form-select d-inline w-auto">
                <option value="today" <?php echo e($periode=='today' ? 'selected' : ''); ?>>Hari Ini</option>
                <option value="7days" <?php echo e($periode=='7days' ? 'selected' : ''); ?>>7 Hari</option>
                <option value="30days" <?php echo e($periode=='30days' ? 'selected' : ''); ?>>30 Hari</option>
            </select>
    ...
    <div class="text-center">
        <div class="total-box">
            Total Keuangan: Rp <?php echo e(number_format($totalPemasukan + $totalPengeluaran, 0, ',', '.')); ?>
...
<script>
    ...
    const totalPemasukan = <?php echo e((int) $totalPemasukan); ?>;
    const totalPengeluaran = <?php echo e((int) $totalPengeluaran); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\proyek1\resources\views/diagram/diagram.blade.php ENDPATH**/ ?>