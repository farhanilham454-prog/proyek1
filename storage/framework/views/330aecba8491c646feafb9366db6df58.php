...
<div id="mainContent" class="main-content container py-4">
    ...
    <!-- Tombol putih -->
    <a href="<?php echo e(url('/transaksi/create')); ?>" class="btn btn-white mb-3">Tambah Transaksi</a>
    ...
    <?php else: ?>
        <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card mb-2 p-3">
                ...
                <div class="mt-2">
                    <a href="<?php echo e(url('/transaksi/'.$trx->id.'/edit')); ?>" class="btn btn-sm btn-warning">Edit</a>
                    <form action="<?php echo e(url('/transaksi/'.$trx->id)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\proyek1\resources\views/transaksi/index.blade.php ENDPATH**/ ?>